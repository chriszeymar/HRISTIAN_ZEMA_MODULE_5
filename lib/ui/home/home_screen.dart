    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext){
        return AlertDialog(
          actions: [
            ...
            ElevatedButton(
                onPressed: (){
                  ...
                  database.clientId =_controller.text;
                  _controller.clear();
                  Navigator.of(context).pop();
                },
          ...
          title: const Text("Order Keeper",style: kTextAveHev16,),
          content: Wrap(
            children: [
              Column(
        ...
        title: BlocBuilder<HomeCubit,HomeState>(
          ...
          builder: (context,state) {
            ...
            if(state.name.isEmpty){
              return const Text("Order Keeper",style: kTextAveHev16);
            }
